        ...
        <div className="space-y-8 stagger-children relative z-10">
            ...
            <div className="bg-card/80 backdrop-blur-md p-6 rounded-xl border border-primary/20 hover-lift hover:border-primary/60 transition-all duration-500 shadow-lg hover:shadow-primary/10">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-2 border-primary/30 pl-6">
                  ...
                  <p className="text-sm text-muted-foreground">{t.about.educationTrainingYears}</p>
                </div>
                <div className="border-l-2 border-primary/30 pl-6">
                  <p className="font-semibold text-foreground text-lg">{t.about.bacDegree}</p>
                  <p className="text-muted-foreground">{t.about.bacSchool}</p>
                  <p className="text-sm text-muted-foreground">{t.about.bacYear}</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-card/80 backdrop-blur-md p-6 rounded-xl border border-primary/20 hover-lift hover:border-primary/60 transition-all duration-500 shadow-lg hover:shadow-primary/10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h4 className="text-xl font-semibold text-primary">{t.about.interests}</h4>
            </div>
            <p className="text-muted-foreground leading-relaxed text-lg">{t.about.interestsValue}</p>
          </div>
        </div>
      </div>
    </section>
